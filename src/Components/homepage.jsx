...
<section id="about" className="about-section" data-aos="fade-right">
  <div className="about-container">
    ...
    <div className="about-text">
      <h1>About Us</h1>
      <p><strong>Prashant Patil Photography</strong> is a team of top candid wedding photographers and filmmakers...</p>
      <p>We specialize in luxury shoots, celebrity weddings, stylized portraits...</p>
      <p>Prashant patil photography has a team of highly experienced and internationally acclaimed wedding photographers and cinematographers specialising in wedding photography in India. 
        Prashant patil photography also offers luxury and lifestyle shoots including celebrity weddings, stylised bridal portraits, glamour portraits,
         creative pre-wedding and engagement shoot at off-beat locations.Over the years,
